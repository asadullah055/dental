...
import { availablePlans } from "@/lib/plants";
      ...
      <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              {plan.id === "year" && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="primary-button px-2 py-1 text-sm rounded-full">
                    Most Popular
                  </span>
                </div>
              )}
        ...
        <div className="text-center">
          <button
            ...
            disabled={isLoading}
            className="inline-flex items-center px-8 py-4 text-black bg-gradient-to-r from-[#00ffbb] to-[#03ffff] rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
          >
            {isLoading ? (
              <>
                <svg
